...
const MaleModel = React.lazy(
  () => import("../components/model_components/MaleModel"),
);
          ...
          <fieldset>
            ...
            <div className="flex flex-col gap-2 mb-4">
              ...
              <div className="flex gap-15 md:gap-25">
                <p
                  className={`p-2 rounded-xl md:w-20 w-15 overflow-hidden text-center font-extrabold border-2 border-r-amber-400 cursor-pointer shadow hover:shadow-amber-300 ${category !== "Bottomwear" ? "bg-cyan-600" : "bg-black-50"}`}
                  onClick={() => setCategory("Upperwear")}
                >
                  Shirt
                </p>
                <p
