...
const handleLoadedMetaData = (i, e) => setLoadedData((pre) => [...pre, e]);
  ...
  return (
    ...
    <div className='mt-10 flex-center relative'>
         <div className='py-5 bg-black-50 rounded-full  flex-center px-7 backdrop-blur'>
            {videoRef.current.map((_,i) => (
                <span
                key={i}
                className='relative  w-3 h-3 mx-2 bg-black-200 rounded-full cursor-pointer'
